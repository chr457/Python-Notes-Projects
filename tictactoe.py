...
print('This is an example for where you can place your markers based on the numbers.')
example_board = ['#', '1', '2', '3', '4', '5', '6', '7', '8' ,'9']
print(displayBoard(example_board))
...
while True:
    ...
    while game_on:
        if turn == 'Player 1':
            ...
            if win_condition(theBoard, player1_marker):
                displayBoard(theBoard)
            ...
            if win_condition(theBoard, player2_marker):
                displayBoard(theBoard)
